...
echo '<script>' >> game.html
cat a_world.js a2_coliseum.js a2b_assoc.js a2c_rose.js a2d_nhm.js a2e_sci.js a2f_courts.js a2g_metro.js a3_landscape.js a4_city.js a4b_skyline.js b_play.js e_crowd.js c_main.js d_loop.js > all.js
node --check all.js
